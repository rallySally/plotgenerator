...
class VocabulariesControllerTest < ActionController::TestCase
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post :create, vocabulary: { article: @vocabulary.article, function: @vocabulary.function, word: @vocabulary.word }
    end
  ...
  test "should update vocabulary" do
    patch :update, id: @vocabulary, vocabulary: { article: @vocabulary.article, function: @vocabulary.function, word: @vocabulary.word }
    assert_redirected_to vocabulary_path(assigns(:vocabulary))
  end
